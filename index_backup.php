  ...
  <body>
    <main class="margin-t-huge">
      <section aria-labelledby="installation-title" aria-describedby="installation-desc" class="container container-tiny margin-b-giant">
        ...
        <p id="installation-desc" class="type-big">You are now running <strong>Bitnami LAMP 7.4.29</strong> in the Cloud.</p>
      </section>
          ...
          <div class="row row-collapse-b-tablet align-center ">
            ...
            <div class="col-6">
              <ul class="remove-style margin-reset">
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/aws/infrastructure/lamp/get-started/get-started/" target="_blank" style="width: 100%;" class="button text-c button-accent">Get Started</a></li>
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/aws/infrastructure/lamp/get-started/access-phpmyadmin/" target="_blank" style="width: 100%;" class="button text-c button-primary">Connect to phpMyAdmin</a></li>
                <li class="padding-v-normal"><a href="https://docs.bitnami.com/aws/infrastructure/lamp/" target="_blank" style="width: 100%;" class="button text-c button-primary">Documentation</a></li>
